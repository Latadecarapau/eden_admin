...
<span style="font-family: verdana, geneva, sans-serif;">
    ...
    <head>
        <title>Eden</title>
        <link rel="stylesheet" href="mainclientes.css" />
            ...
            <section class="main">
                ...
                <div class="main-body">
                    <div class="button-container">
                        <button class="button-container" onclick="location.href='verclientes.php'">Ver Clientes</button>
                        <button class="button-container" onclick="location.href='addclientes.php'">Registar cliente</button>
                    </div>
                </div>
