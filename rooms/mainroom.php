            ...
            <section class="main">
                ...
                <div class="main-body">
                    <div class="button-container">
                        <button class="button-container" onclick="location.href='consultroom.php'">Consultar Quartos</button>
                        <button class="button-container" onclick="location.href='makeroom.php'">Implementar Quartos</button>
                    </div>
                </div>
